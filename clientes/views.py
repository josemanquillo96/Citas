    ...
    def form_valid(self, form):
        try:
            ...
            if 'UNIQUE constraint failed' in e.args[0]:
                messages.warning(self.request, 'No se puede marcar esta consulta')
        ...
        messages.info(self.request, 'Cita agendada con exito!')
...
class ConsultaDeleteView(LoginRequiredMixin, DeleteView):
    ...
    def get_success_url(self):
        messages.success(self.request, "Consulta hecha con exito!")
