    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sexo', models.CharField(choices=[('MAS', 'Maculino'), ('FEM', 'Femenino')], max_length=9)),
                ('telefone', models.CharField(blank=True, max_length=17, null=True, validators=[django.core.validators.RegexValidator(message="formato invalido", regex='^\\+?1?\\d{9,15}$')], verbose_name='Telefono')),
